                 ...
                 if(choice=='c'){
                     ...
                     do{
                         ...
                         if(customerLoginData.containsKey(customerName)){
                             ...
                             PrintWriter outstream=new PrintWriter(new FileOutputStream("customerLoginData.txt",true));
                             outstream.println();
                ...
                try {
                    ...
                    if (loggedInSuccessfully == false) {
                        ...
                        if(accepted=='y'){
                            ...
                            acceptRide=true;
                            chosenDriver.changeAvailableStatus();//driver is now unavailable and no one else can call the same driver again
                            try{
                                Thread.sleep(1000); //just to make app more realistic.
                           }catch(Exception e){
                               System.out.println(e);
                           ...
                           System.out.println("Your ride has been accepted the driver will arrive in "+currentETA+" minutes");
                           ...
                           System.out.println("Thanks For Using Our App!!");
                            ...
                            System.out.println("Ride rejected...Giving Control back to customer to change the selected driver");
                            try{
                                Thread.sleep(1000); //just to make app more realistic.
                           }catch(Exception e){
                               System.out.println(e);
